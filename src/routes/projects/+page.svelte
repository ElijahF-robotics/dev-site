<script>
	...
	const projects = [
		...
		{
			title: 'Atto',
			github: 'https://github.com/ElijahF-robotics/atto',
			link: NaN,
			image: attoImg,
			description:
				'This is a terminal editor. It was a chance for me to learn the basics of Rust and terminal' +
		...
		{
			title: 'Homepage',
			github: 'https://github.com/ElijahF-robotics/Homepage',
			link: 'https://homepage.elijahflader.dev',
			image: homepageImg,
			description:
				"While Safari's default homepage is fine, I wanted to build something" +
		...
		{
			title: 'Color Game',
			github: 'https://github.com/ElijahF-robotics/color-game',
			link: 'https://colors.elijahflader.dev',
			image: colorgameImg,
			description:
				"I wanted to learn React, so I built this little game. It's fairly simple" +
...

		{
			...
			image: websiteImg,
			description:
				"This website! It's built in svelte and hosted on Vercel. It holds" +
	...
	<div class="relative h-full w-full overflow-hidden">
		{#each visibleProjects as project, i (currentIndex + i)}
			<div
				...
				style:z-index={-i}
			>
				<ProjectCard {project} offset={i} zIndex={-i} />
			</div>
		{/each}
	</div>
	<div class="flex h-full flex-col items-center justify-center space-y-10 pt-4 pb-4">
